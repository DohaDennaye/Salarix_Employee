    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html">
                <img src="https://ui-avatars.com/api/?name={{ AppNameGetter::getAppName() ? AppNameGetter::getAppName() : 'SALARIX' }}"
                    alt="user profile" class="logo-icon me-2">
                {{ AppNameGetter::getAppName() ? AppNameGetter::getAppName() : 'SALARIX' }}</a>
        </div>
        <!--//app-branding-->
